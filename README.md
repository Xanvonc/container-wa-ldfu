...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-wa-ldfu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-wa-ldfu.containers.anotherwebservice.com/
...
```
git clone git@github.com:Xanvonc/container-wa-ldfu.git
cd container-wa-ldfu
```
...
```
docker attach container-wa-ldfu
```
